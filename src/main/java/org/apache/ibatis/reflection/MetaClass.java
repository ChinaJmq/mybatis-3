...
public class MetaClass {
  ...
  /**
   * 这里设计的反射参见https://blog.csdn.net/kingdam578/article/details/78656626
   * @param prop
   * @return
   */
  private Class<?> getGetterType(PropertyTokenizer prop) {
    ...
    if (prop.getIndex() != null && Collection.class.isAssignableFrom(type)) {
      ...
      if (returnType instanceof ParameterizedType) {
        //返回表示此类型实际类型参数的 Type 对象的数组。如Map<String, Integer>，则会返回class java.lang.String，class java.lang.Integer
        ...
        if (actualTypeArguments != null && actualTypeArguments.length == 1) {
          ...
          if (returnType instanceof Class) {
            ...
            //如Map<String, Integer> list 则为interface java.util.Ma
